...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let testimonials = [
        { name: 'Gautam', city: 'Delhi', text: 'Thank you for the amazing and beautiful cakes you made for my daughter. She was undoubtedly happy after seeing them and they were exactly what we wanted. The Peppa Pig cake you made by your own choice was a great surprise. I truly appreciate your patience regarding the payment. You didn\'t even call me once, understanding that I must have been busy. That thoughtfulness means a lot.', date: '2024-09-15', image: 'images/26.jpeg' },
        { name: 'Dr. Farheen', city: 'Faridabad', text: 'Thank you so much for making such a beautiful cake in the flavor we requested, that too at the 11th hour. I have ordered from you before and I must say the taste and design of your cakes is always par excellence. I\'ll definitely recommend it to others.', date: '2024-09-20', image: 'images/27.jpg' },
        { name: 'Gayatri', city: 'Gurgaon', text: 'Very yum cupcakes, the prettier they were the tastier. Also the cake looked unreal. Thank you so much! We all love your cakes. You are our go to baker now. Never buying cakes from anyone else.', date: '2024-09-28', image: 'images/28.jpg' },
        { name: 'Meenakshi', city: 'Delhi', text: 'Cake was yum and apt size as per our need. Your cakes never disappoint us. Best thing is your cake sponges are never over drenched with sugar syrup which makes it moderately sweet. Thanks for always delivering the best.', date: '2024-10-02', image: 'images/29.jpg' },
        ...
        { name: 'Anshula', city: 'Noida', text: 'The cake was delicious and it looked wonderful! Just the way I wanted. Thank you so much for making the occasion extra special with your cake.', date: '2024-10-12', image: '' },
        { name: 'Parul', city: 'Delhi', text: 'My daughter said cake was very delicious. She liked the cake very much. Thank you so much for making her day more beautiful.', date: '2024-10-18', image: '' },
        ...
        { name: 'Snehi', city: 'Gurgaon', text: 'I am very thankful for the last min order that you delivered before time. Thank you sooo much. You never disappoint me with the quality and taste. Mother\'s day got more special with this super yummy and beautiful cake. My mom loved it and was super happy.', date: '2024-10-28', image: '' },
        { name: 'Dr. Neha', city: 'Delhi', text: 'Lovely cake! Kids finished it within 5 minutes of cutting. Yuvraj loved the clouds and drawing.', date: '2024-11-02', image: '' },
        { name: 'Brizel', city: 'Noida', text: 'The cake was absolutely delicious, and the attention to detail was incredible. It exceeded our expectations in both taste and presentation. I would highly recommend Cakes4u for any special occasion. Thank you for making her birthday even more memorable!', date: '2024-11-08', image: '' },
